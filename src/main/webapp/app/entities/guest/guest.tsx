...
import { getEntities, reset } from './guest.reducer';
// tslint:disable-next-line:no-unused-variable
import { ITEMS_PER_PAGE } from 'app/shared/util/pagination.constants';

export interface IGuestProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export type IGuestState = IPaginationBaseState;

export class Guest extends React.Component<IGuestProps, IGuestState> {
  state: IGuestState = {
...
const mapStateToProps = ({ guest }: IRootState) => ({
  ...
  links: guest.links,
  entity: guest.entity,
  updateSuccess: guest.updateSuccess
});
